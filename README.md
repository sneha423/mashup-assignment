...
mashup-assignment/
├─ requirements.txt
├─ 102303033.py           # Program 1 – CLI (name = roll number)
├─ mashup_core/
│   ├─ __init__.py
│   └─ mashup.py          # Shared mashup logic
└─ webapp/
    ├─ app.py             # Program 2 – Flask web service
    └─ templates/
        └─ index.html     # Web form + progress bar
...
5. Shared Mashup Logic
The core mashup logic is implemented in mashup_core/mashup.py as a function create
